...
namespace TP_02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            changoDeCompras += (Producto)c1;
            changoDeCompras += (Producto)c2;
            changoDeCompras += (Producto)m1;
            changoDeCompras += (Producto)m2;
            changoDeCompras += (Producto)a1;
            changoDeCompras += (Producto)a2;
            changoDeCompras += (Producto)a3;
